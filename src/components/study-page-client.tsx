...
import { ArrowRight, Clock, Users, MapPin, ToggleLeft, ToggleRight, ChevronLeft, ChevronRight } from 'lucide-react'
...
export default function StudyPageClient({ studyPage, countryData }: StudyPageClientProps) {
  ...
  // Filter cards based on active tab and selected category
  const filteredCards = allCards.filter((card: any) => {
    ...
    return isActiveMatch && categoryMatch
  })
